...
import { RSVPCreateFormStyles } from "./RSVPCreatePageStyles";
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <Box
        ...
        sx={{
          ...RSVPCreateFormStyles.fieldBoxStyles,
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <Box
            sx={{
              ...RSVPCreateFormStyles.formBoxStyles,
          ...
          >
            <Box
              sx={{
                ...RSVPCreateFormStyles.firstInputGroupStyles,
            ...
            <Box sx={RSVPCreateFormStyles.secondInputGroupStyles}>
              <FormAutoComplete
                name="date"
                control={control}
                options={dates}
              ...
              <Button
                ...
                variant="contained"
                color="primary"
                sx={RSVPCreateFormStyles.buttonStyles}
              >
                Send
              </Button>
            </Box>
