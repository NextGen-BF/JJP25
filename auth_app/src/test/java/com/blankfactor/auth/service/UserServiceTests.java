...
class UserServiceTests {
    ...
    void shouldSuccessfullyReturnTheExistingUsers() {
        // Given
        User user1 = new User(1L, "example1@email.com", "Pass_123", "UserName", "User", "Name", LocalDateTime.now(), false, null, Set.of(Role.ROLE_USER));
        User user2 = new User(2L, "example2@email.com", "456_Pass", "NameUser", "Name", "User", LocalDateTime.now(), true, null, Set.of(Role.ROLE_ADMIN));
